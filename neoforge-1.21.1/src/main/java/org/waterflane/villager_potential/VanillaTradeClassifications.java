...
/**
 * Stable specialization categories for the Minecraft 1.21.1 vanilla pools.
 *
...
public final class VanillaTradeClassifications {
    ...
    private static void registerNormal(
        ...
        register(result, VillagerTrades.TRADES, VillagerProfession.CARTOGRAPHER, Map.of(
                ...
                3, list(CARTOGRAPHY_SUPPLIES, MAPS, MAPS),
                4, repeat(DECOR, 17),
                5, list(DECOR)
        ));
    ...
    private static void registerExperimental(
        ...
        register(result, VillagerTrades.EXPERIMENTAL_TRADES, VillagerProfession.LIBRARIAN, Map.of(
                1, list(ORDINARY_BOOKS, ENCHANTED_BOOKS, ORDINARY_BOOKS),
                2, list(ORDINARY_BOOKS, ENCHANTED_BOOKS, GENERAL),
                3, list(ORDINARY_BOOKS, ENCHANTED_BOOKS, GENERAL),
                4, list(ORDINARY_BOOKS, GENERAL, GENERAL),
                5, list(ENCHANTED_BOOKS, GENERAL)
        ));
        register(result, VillagerTrades.EXPERIMENTAL_TRADES, VillagerProfession.ARMORER, Map.of(
                1, repeat(SMITHING_MATERIALS, 2),
                2, repeat(ARMOR, 8),
                3, list(SMITHING_MATERIALS, ARMOR, GENERAL),
                4, repeat(ARMOR, 26),
                5, sequence(ARMOR, 14, SMITHING_MATERIALS, 2)
        ));
        register(result, VillagerTrades.EXPERIMENTAL_TRADES, VillagerProfession.CARTOGRAPHER, Map.of(
                1, list(CARTOGRAPHY_SUPPLIES, MAPS),
                2, sequence(CARTOGRAPHY_SUPPLIES, 1, MAPS, 3),
                3, list(CARTOGRAPHY_SUPPLIES, MAPS, MAPS),
                4, repeat(DECOR, 17),
                5, list(DECOR, MAPS)
        ));
